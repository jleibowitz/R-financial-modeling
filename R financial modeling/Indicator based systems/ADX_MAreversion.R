...
GBPUSDlt<-read.csv(file="C://TickDownloader/tickdata/GBPUSD_M15_UTC+0_00.csv",header=TRUE,stringsAsFactors=FALSE)
...
GBPUSDlt<-(GBPUSDlt["2014-02-01/2014-08-01"])
...
GBPUSD<-(GBPUSD["2014-02-01/2014-08-01"])
